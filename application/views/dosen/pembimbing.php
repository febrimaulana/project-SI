								...
								<?php foreach ($dosen as $data) : ?>
									<tr>
										...
										<td>
											...
											<a href="<?= base_url('dosen/pembimbing/hapus/') . $data['id_dosen'] ?>" class="btn btn-danger btn-sm hapus">Hapus</a>
										</td>
									</tr>
								<?php endforeach; ?>
							</tbody>
...
<div class="modal fade" id="exampleModalCenter" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('dosen/pembimbing') ?>" method="post" id="formdosenpembimbing">
...
<div class="modal fade" id="UbahDosen" role="dialog" aria-labelledby="UbahDosenTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form action="<?= base_url('dosen/pembimbing/ubah') ?>" method="post" id="formubahdosenpembimbing">
				<div class="modal-body">
					<div class="form-group">
