                    ...
                    <div class="col-lg-6 bg-white">
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                ...
                                </form><a href="#" class="forgot-pass">Forgot Password?</a><br><small>Do not have an account? </small><a href="<?= base_url('auth/signup'); ?>" class="signup">Signup</a>
                            </div>
                        </div>
                    </div>
                </div>
